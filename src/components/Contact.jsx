...
const Contact = () => {
    ...
    <div name='contact' className='w-full h-screen flex justify-center items-center p-4'>
        <form method='POST' action='https://getform.io/f/7ade0401-1017-47ef-80fa-302d7a595b6c' className='flex flex-col max-w-[600px] w-full '>
            ...
            <input className='bg-slate-200 p-2 rounded' type='text' placeholder='Name' name='name'/>
            <input className='my-4 p-2 bg-slate-200 rounded' type='email' placeholder='Email' name='email'/>
            <textarea className='bg-slate-200 p-2 rounded' name='message' rows={10} placeholder='Message'></textarea>
